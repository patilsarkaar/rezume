...
<head>
    ...
    <!-- FONT AWESOME -->
    <link href="<?php echo base_url(); ?>assets/stylesheets/font-awesome.min.css" rel="stylesheet">


    <!-- ANIMATION -->
    <link href="<?php echo base_url(); ?>assets/stylesheets/animate.min.css" rel="stylesheet">


    <!-- MATERIALIZE -->
    <link href="<?php echo base_url(); ?>assets/stylesheets/materialize.css" rel="stylesheet">
    <!-- BOOTSTRAP -->
    <link href="<?php echo base_url(); ?>assets/stylesheets/bootstrap.min.css" rel="stylesheet">


    <!-- CUSTOM STYLE -->
    <link href="<?php echo base_url(); ?>assets/stylesheets/style_blue_blend.css" id="switch_style" rel="stylesheet">
...
<header id="home">
    <nav id="theMenu" class="menu">
        ...
        <div id="menu-options" class="menu-wrap">
            ...
            <!--PERSONAL LOGO-->
            <div class="logo-flat">
                <img alt="personal-logo" class="img-responsive" src="<?php echo base_url(); ?>assets/images/john.png">
            </div>
            <br>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div id="v-card" class="card">
                            ...
                            <div id="profile" class="right">
                                <img alt="profile-image" class="img-responsive" src="<?php echo base_url(); ?>assets/images/prasad.jpg">
                                <div class="slant"></div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="info-headings">
                                    <h4 class="text-uppercase left"><?php echo $row->firstName ."&nbsp;". $row->lastName;  ?></h4>
                                    <h6 class="text-capitalize left"><?php echo $row->designation; ?></h6>
                                </div>
                                ...
                                <div class="infos">
                                    <ul class="profile-list">
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <span class="content"><?php echo $row->website; ?></span>
                                        </li>
                                        <li class="clearfix">
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <span class="content"><?php echo $row->contact_no; ?></span>
                                        </li>
                                        <li class="clearfix">
...
<section id="education" class="section">
    <div class="container">
        ...
        <div id="timeline-education">
          ...
          <?php if (isset($education)) : foreach($education as $row) : ?>
            <!-- FIRST TIMELINE -->
            <div class="timeline-block">
                <!-- DOT -->
                <div class="timeline-dot"><i class="title-icon fa fa-graduation-cap"></i></div>
                <!-- TIMELINE CONTENT -->
                <div class="card timeline-content">
                    <div class="card-content">
                        <!-- TIMELINE TITLE -->
                        <h6 class="timeline-title"><?php echo $row->institute ?></h6>
                        <!-- TIMELINE TITLE INFO -->
                        <div class="timeline-info">
                            ...
                            <h6>
                                <small><?php echo $row->start_date."-".$row->end_date ?></small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="skills-title">
                                    <h6 class="text-center">Professional
                                      <a href="#" class="modal-dot" data-toggle="modal" data-target="#skills-1"  title="Add more skills !">
                                ...
                                <!-- buffer row -->
                                <div class="skillbar" data-percent="<?php echo $row->percentage ?>%">
                                    <div class="skillbar-title"><span><?php echo $row->skill ?></span></div>
                                    <div class="skillbar-bar"></div>
                                    <div class="skill-bar-percent"><?php echo $row->percentage ?>%</div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <?php if (isset($personal)): foreach ($personal as $row) :?>
                                <div class="skillbar" data-percent="<?php echo $row->percentage ?>%">
                                    <div class="skillbar-title"><span><?php echo $row->skill ?></span></div>
                                    <div class="skillbar-bar"></div>
                                    <div class="skill-bar-percent"><?php echo $row->percentage ?>%</div>
...
<!--==========================================
                  MODALS
===========================================-->
<div class="modal fade" id="skills-1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel-1">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <!--MODAL HEADER-->
            <div class="modal-header  text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel-1">PROFESSIONAL SKILLS </h4>
                <!-- <h6>
                    <small>Jan 2014 - Mar 2015</small>
                </h6> -->
            </div>
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" action="<?php echo base_url();?>index.php/Rezume/create/professional_skills" method="post">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="percentage">Proficiency:</label>
                <div class="col-sm-10">
                  <input type="range" class="form-control" id="percentage" name="percentage" min="10" max="100">
                </div>
              </div>
                ...
                <div id="a">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 grid big inLeft">
                        <figure class="port-effect">
                            <img src="<?php echo base_url(); ?>assets/images/portfolio.png" class="img-responsive" alt="portfolio-demo"/>
                            <figcaption>
                        ...
                        <div class="item active">
                            <div class="col-md-12">
                                ...
                                <div class="ben center-block">
                                    <img alt="client-image" class="center-block" src="<?php echo base_url(); ?>assets/images/client.png">
                                </div>
                                <!--CLIENT QUOTE-->
                                <blockquote>
                    ...
                    <div class="card">
                        <div class="clients-wrap">
                            ...
                            <ul id="clients-list" class="clearfix">
                                <li><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="client-logo"></li>
                                <li><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="client-logo"></li>
                                <li><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="client-logo"></li>
                                <li><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="client-logo"></li>
                                <li><img src="<?php echo base_url(); ?>assets/images/logo.png" alt="client-logo"></li>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="blog odd">
                        <!--IMAGE-->
                        <div class="image">
                            <img alt="blog-image" src="<?php echo base_url(); ?>assets/images/blog.png"/>
...
<script src="<?php echo base_url(); ?>assets/javascript/materialize.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=YOUR API KEY"></script>
<script src="<?php echo base_url(); ?>assets/javascript/markerwithlabel.min.js"></script>
<script src="<?php echo base_url(); ?>assets/javascript/retina.min.js"></script>
<script src="<?php echo base_url(); ?>assets/javascript/scrollreveal.min.js"></script>
<script src="<?php echo base_url(); ?>assets/javascript/jquery.touchSwipe.min.js"></script>
<script src="<?php echo base_url(); ?>assets/javascript/custom.js"></script>
